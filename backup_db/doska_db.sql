...
-- Дамп данных таблицы doska.jos_assets: ~84 rows (приблизительно)
...
INSERT INTO `jos_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
	(1, 0, 0, 171, 0, 'root.1', 'Root Asset', '{"core.login.site":{"6":1,"2":1},"core.login.admin":{"6":1,"3":1},"core.login.offline":{"6":1},"core.admin":{"8":1},"core.manage":{"7":1},"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
	...
	(65, 1, 131, 140, 1, 'com_doska', 'COM_DOSKA', '{"core.manage":{"3":1},"core.edit.state.own":{"3":1},"core.edit":{"3":0},"core.create.messages":{"3":1}}'),
	(68, 1, 141, 142, 1, '#__doska_types.3', '#__doska_types.3', '{}'),
	(69, 1, 143, 144, 1, '#__doska_types.4', '#__doska_types.4', '{}'),
	(70, 1, 145, 146, 1, '#__doska_types.5', '#__doska_types.5', '{}'),
	(71, 1, 147, 148, 1, '#__doska_types.6', '#__doska_types.6', '{}'),
	(72, 1, 149, 150, 1, '#__doska_types.7', '#__doska_types.7', '{}'),
	(73, 1, 151, 152, 1, '#__doska_types.8', '#__doska_types.8', '{}'),
	...
	(79, 1, 153, 154, 1, '#__doska_post.1', '#__doska_post.1', '{}'),
	(80, 1, 155, 156, 1, '#__doska_post.2', '#__doska_post.2', '{}'),
	(81, 1, 157, 158, 1, '#__doska_post.3', '#__doska_post.3', '{}'),
	(82, 1, 165, 166, 1, 'com_doska.message.2', 'Телевизор LG', '{}'),
	(83, 1, 161, 162, 1, 'com_doska.message.3', 'Горный велосипед ', '{}'),
	(84, 1, 163, 164, 1, 'com_doska.message.1', 'Автомобиль Pegout', '{}'),
	(85, 65, 132, 133, 2, 'com_doska.category.15', 'Компьютеры', '{}'),
	(86, 65, 134, 135, 2, 'com_doska.category.5', 'Музыкальные центры', '{}'),
	(87, 1, 159, 160, 1, '#__doska_categories.14', '#__doska_categories.14', '{"core.create":{"1":1}}'),
	...
	(90, 1, 167, 168, 1, 'com_doska.message.5', 'Мотоцикл Иж-Юпитер', '{}'),
	(91, 1, 169, 170, 1, 'com_doska.message.6', 'Мотоцикл Харлей Девидсон', '{}');
...
INSERT INTO `jos_doska_categories` (`id`, `name`, `parentid`, `alias`, `state`, `params`, `ordering`, `asset_id`) VALUES
	(2, 'Автомобили', 6, 'avtomobili3', 1, '{"show_category":"1","image":"","image_alt":""}', 1, NULL),
...
-- Дамп данных таблицы doska.jos_doska_post: ~6 rows (приблизительно)
...
INSERT INTO `jos_doska_post` (`id`, `introtext`, `fulltext`, `title`, `text`, `id_user`, `id_categories`, `id_types`, `town`, `images`, `confirm`, `price`, `created`, `publish_up`, `publish_down`, `ordering`, `hits`, `metadesc`, `metakey`, `modified`, `alias`, `state`, `params`, `asset_id`) VALUES
	(1, '<p><b>Peugeot</b> (<small>МФА <span class="ref-info" style="cursor: help;" title="на французском языке">(фр.)</span>:</small> <span class="IPA"><a title="Международный фонетический алфавит" href="https://ru.wikipedia.org/wiki/%D0%9C%D0%B5%D0%B6%D0%B4%D1%83%D0%BD%D0%B0%D1%80%D0%BE%D0%B4%D0%BD%D1%8B%D0%B9_%D1%84%D0%BE%D0%BD%D0%B5%D1%82%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9_%D0%B0%D0%BB%D1%84%D0%B0%D0%B2%D0%B8%D1%82">[pø.ʒo]</a></span>; произношение названия близко к «<i>пёжо́</i>», однако в русском языке закрепилась <a title="Французско-русская практическая транскрипция" href="https://ru.wikipedia.org/wiki/%D0%A4%D1%80%D0%B0%D0%BD%D1%86%D1%83%D0%B7%D1%81%D0%BA%D0%BE-%D1%80%D1%83%D1%81%D1%81%D0%BA%D0%B0%D1%8F_%D0%BF%D1%80%D0%B0%D0%BA%D1%82%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B0%D1%8F_%D1%82%D1%80%D0%B0%D0%BD%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%86%D0%B8%D1%8F">транскрипция</a> «<i>пежо́</i>») — один из основных <a title="Франция" href="https://ru.wikipedia.org/wiki/%D0%A4%D1%80%D0%B0%D0%BD%D1%86%D0%B8%D1%8F">французских</a> производителей автомобилей, часть <a class="mw-redirect" title="PSA Peugeot Citroën" href="https://ru.wikipedia.org/wiki/PSA_Peugeot_Citro%C3%ABn">PSA Peugeot Citroën</a>. По данным 2007 года материнская компания PSA Peugeot Citroën является вторым по величине в <a title="Европа" href="https://ru.wikipedia.org/wiki/%D0%95%D0%B2%D1%80%D0%BE%D0%BF%D0%B0">Европе</a> производителем автомобилей<sup id="cite_ref-oica.net_2-0" class="reference"><a href="https://ru.wikipedia.org/wiki/Peugeot#cite_note-oica.net-2">[2]</a></sup>.</p>\r\n', '\r\n<p>Это крупнейший в Европе производитель лёгких коммерческих автомобилей (18,8 % рынка) и лидер в производстве автомобилей с низким уровнем выхлопа (26,2 % рынка автомобилей, уровень выхлопа которых менее 130 г/км).</p>', 'Автомобиль Pegout', '<p><b>Peugeot</b> (<small>МФА <span class="ref-info" style="cursor: help;" title="на французском языке">(фр.)</span>:</small> <span class="IPA"><a title="Международный фонетический алфавит" href="https://ru.wikipedia.org/wiki/%D0%9C%D0%B5%D0%B6%D0%B4%D1%83%D0%BD%D0%B0%D1%80%D0%BE%D0%B4%D0%BD%D1%8B%D0%B9_%D1%84%D0%BE%D0%BD%D0%B5%D1%82%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9_%D0%B0%D0%BB%D1%84%D0%B0%D0%B2%D0%B8%D1%82">[pø.ʒo]</a></span>; произношение названия близко к «<i>пёжо́</i>», однако в русском языке закрепилась <a title="Французско-русская практическая транскрипция" href="https://ru.wikipedia.org/wiki/%D0%A4%D1%80%D0%B0%D0%BD%D1%86%D1%83%D0%B7%D1%81%D0%BA%D0%BE-%D1%80%D1%83%D1%81%D1%81%D0%BA%D0%B0%D1%8F_%D0%BF%D1%80%D0%B0%D0%BA%D1%82%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B0%D1%8F_%D1%82%D1%80%D0%B0%D0%BD%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%86%D0%B8%D1%8F">транскрипция</a> «<i>пежо́</i>») — один из основных <a title="Франция" href="https://ru.wikipedia.org/wiki/%D0%A4%D1%80%D0%B0%D0%BD%D1%86%D0%B8%D1%8F">французских</a> производителей автомобилей, часть <a class="mw-redirect" title="PSA Peugeot Citroën" href="https://ru.wikipedia.org/wiki/PSA_Peugeot_Citro%C3%ABn">PSA Peugeot Citroën</a>. По данным 2007 года материнская компания PSA Peugeot Citroën является вторым по величине в <a title="Европа" href="https://ru.wikipedia.org/wiki/%D0%95%D0%B2%D1%80%D0%BE%D0%BF%D0%B0">Европе</a> производителем автомобилей<sup id="cite_ref-oica.net_2-0" class="reference"><a href="https://ru.wikipedia.org/wiki/Peugeot#cite_note-oica.net-2">[2]</a></sup>.</p>\r\n<hr id="system-readmore" />\r\n<p>Это крупнейший в Европе производитель лёгких коммерческих автомобилей (18,8 % рынка) и лидер в производстве автомобилей с низким уровнем выхлопа (26,2 % рынка автомобилей, уровень выхлопа которых менее 130 г/км).</p>', 173, 7, 5, 'Минск', '{"img":"peugeot1.jpg","mini1":"peugeot2.jpg","mini2":"peugeot3.jpg","mini3":""}', '1', 36, '2018-07-23 11:59:39', '2018-08-08 11:59:39', '2018-08-15 14:24:36', 0, 0, 'продажа машины', 'машины', '0000-00-00 00:00:00', 'avtomobil-pegout', 1, '{"show_category":"","show_type":"","show_town":""}', 84),
	(2, '', '', 'Телевизор LG', '', 173, 4, 3, 'Могилёв', '{"img":"televizor.jpg","mini1":"televizor2.jpg","mini2":"televizor3.jpg","mini3":""}', '1', 350, '2018-07-25 08:34:55', '2018-08-08 08:34:55', '2018-08-15 12:13:18', 0, 0, '', '', '0000-00-00 00:00:00', 'televizor-lg', 1, '{"show_category":"1","show_type":"","show_town":""}', 82),
	(3, '', '', 'Горный велосипед ', '', 173, 8, 3, 'Киев', '{"img":"velosiped.jpg","mini1":"velosiped2.jpg","mini2":"velosiped3.jpg","mini3":""}', '1', 354, '2018-08-02 07:26:37', '2018-08-02 07:26:37', '2018-08-09 07:26:37', 0, 0, 'Мета описание', 'Меда слова', '0000-00-00 00:00:00', 'gornyj-velosiped', 1, '{"show_category":"0","show_type":"","show_town":""}', 83),
	(4, '<p>Куплю тренажёр</p>', '', 'Велотренажёр', '<p>Куплю тренажёр</p>', 173, 14, 3, 'Борисов', '{"img":"velo.jpg","mini1":"velo2.jpg","mini2":"","mini3":""}', '1', 133, '2018-08-06 12:43:43', '2018-08-06 12:43:43', '2018-08-13 12:43:43', 0, 0, '', '', '0000-00-00 00:00:00', 'velotrenazhjor', 1, '{"show_category":"0","show_type":"","show_town":""}', 89),
	(5, '', '', 'Мотоцикл Иж-Юпитер', '', 173, 7, 3, 'Могилёв', '{"img":"yupiter1.jpg","mini1":"yupiter4.jpg","mini2":"yupiter3.jpg","mini3":""}', '1', 245, '2018-08-07 07:00:36', '2018-08-07 07:00:36', '2018-08-14 07:00:36', 0, 0, '', '', '0000-00-00 00:00:00', 'mototsikl-izh-yupiter', 1, '{"show_category":"","show_type":"","show_town":""}', 90),
	(6, '<p><b>Harley-Davidson Motor Company</b> (по-русски <b>Харли-Дэвидсон</b>, NYSE: <b>HOG</b>, раньше известная как HDI<sup>[1]</sup>) — американский производитель мотоциклов и сертифицированный поставщик продукции военного назначения для <a title="Вооружённые силы США" href="https://ru.wikipedia.org/wiki/%D0%92%D0%BE%D0%BE%D1%80%D1%83%D0%B6%D1%91%D0%BD%D0%BD%D1%8B%D0%B5_%D1%81%D0%B8%D0%BB%D1%8B_%D0%A1%D0%A8%D0%90">Вооружённых сил США</a> (с <a title="1982 год" href="https://ru.wikipedia.org/wiki/1982_%D0%B3%D0%BE%D0%B4">1982 года</a>),<sup id="cite_ref-2" class="reference"><a href="https://ru.wikipedia.org/wiki/Harley-Davidson#cite_note-2">[2]</a></sup><sup id="cite_ref-3" class="reference"><a href="https://ru.wikipedia.org/wiki/Harley-Davidson#cite_note-3">[3]</a></sup> базирующийся в городе <a title="Милуоки" href="https://ru.wikipedia.org/wiki/%D0%9C%D0%B8%D0%BB%D1%83%D0%BE%D0%BA%D0%B8">Милуоки</a>, штат <a title="Висконсин" href="https://ru.wikipedia.org/wiki/%D0%92%D0%B8%D1%81%D0%BA%D0%BE%D0%BD%D1%81%D0%B8%D0%BD">Висконсин</a>, с производственными мощностями в других регионах США и за пределами страны. Компания производит и продаёт тяжёлые мотоциклы, предназначенные для езды по шоссе.</p>\r\n', '\r\n<p>Особенность маркетинговой политики Harley — создание сообщества людей, лояльных именно к этой марке. Помимо мотоциклов, компания выпускает множество товаров широкого потребления с эмблемой Harley-Davidson. Одежда, обувь, мебель, посуда, выпускаемые под этой маркой, позволяет создать своеобразный стиль жизни от Харли, который делает мотоцикл по-настоящему культовым. Также каждый владелец любого из мотоциклов Харли имеет возможность вступить в созданное брендом сообщество владельцев мотоциклов этой марки (H.O.G. — Harley Owners Group). На сегодня H.O.G. — самый многочисленный клуб любителей мотоциклов в мире, насчитывающий более миллиона участников.</p>\r\n<p>В 2008 году компания выкупила у семьи Кастильони 100 % акций компании MV Agusta Group, которая производит мотоциклы под брендами MV Agusta и <a title="Cagiva" href="https://ru.wikipedia.org/wiki/Cagiva">Cagiva</a>.</p>', 'Мотоцикл Харлей Девидсон', '<p><b>Harley-Davidson Motor Company</b> (по-русски <b>Харли-Дэвидсон</b>, NYSE: <b>HOG</b>, раньше известная как HDI<sup>[1]</sup>) — американский производитель мотоциклов и сертифицированный поставщик продукции военного назначения для <a title="Вооружённые силы США" href="https://ru.wikipedia.org/wiki/%D0%92%D0%BE%D0%BE%D1%80%D1%83%D0%B6%D1%91%D0%BD%D0%BD%D1%8B%D0%B5_%D1%81%D0%B8%D0%BB%D1%8B_%D0%A1%D0%A8%D0%90">Вооружённых сил США</a> (с <a title="1982 год" href="https://ru.wikipedia.org/wiki/1982_%D0%B3%D0%BE%D0%B4">1982 года</a>),<sup id="cite_ref-2" class="reference"><a href="https://ru.wikipedia.org/wiki/Harley-Davidson#cite_note-2">[2]</a></sup><sup id="cite_ref-3" class="reference"><a href="https://ru.wikipedia.org/wiki/Harley-Davidson#cite_note-3">[3]</a></sup> базирующийся в городе <a title="Милуоки" href="https://ru.wikipedia.org/wiki/%D0%9C%D0%B8%D0%BB%D1%83%D0%BE%D0%BA%D0%B8">Милуоки</a>, штат <a title="Висконсин" href="https://ru.wikipedia.org/wiki/%D0%92%D0%B8%D1%81%D0%BA%D0%BE%D0%BD%D1%81%D0%B8%D0%BD">Висконсин</a>, с производственными мощностями в других регионах США и за пределами страны. Компания производит и продаёт тяжёлые мотоциклы, предназначенные для езды по шоссе.</p>\r\n<hr id="system-readmore" />\r\n<p>Особенность маркетинговой политики Harley — создание сообщества людей, лояльных именно к этой марке. Помимо мотоциклов, компания выпускает множество товаров широкого потребления с эмблемой Harley-Davidson. Одежда, обувь, мебель, посуда, выпускаемые под этой маркой, позволяет создать своеобразный стиль жизни от Харли, который делает мотоцикл по-настоящему культовым. Также каждый владелец любого из мотоциклов Харли имеет возможность вступить в созданное брендом сообщество владельцев мотоциклов этой марки (H.O.G. — Harley Owners Group). На сегодня H.O.G. — самый многочисленный клуб любителей мотоциклов в мире, насчитывающий более миллиона участников.</p>\r\n<p>В 2008 году компания выкупила у семьи Кастильони 100 % акций компании MV Agusta Group, которая производит мотоциклы под брендами MV Agusta и <a title="Cagiva" href="https://ru.wikipedia.org/wiki/Cagiva">Cagiva</a>.</p>', 173, 7, 3, 'Москва', '{"img":"harley-davidson.jpg","mini1":"harley-davidson-v-rod-jpg.jpg","mini2":"harley.jpeg","mini3":"harley.png"}', '1', 346, '2018-08-07 07:12:31', '2018-08-07 07:12:31', '2018-08-14 07:12:31', 0, 0, '', '', '0000-00-00 00:00:00', 'novoe-ob-yavlenie-dva', 1, '{"show_category":"","show_type":"","show_town":""}', 91);
...
INSERT INTO `jos_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
	...
	(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '', '{"lastrun":1533820980}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
	(453, 0, 'plg_editors-xtd_module', 'plugin', 'module', 'editors-xtd', 0, 1, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
	(454, 0, 'plg_system_stats', 'plugin', 'stats', 'system', 0, 1, 1, 0, '', '{"mode":1,"lastrun":1533805512,"unique_id":"713c198589bf63b8a97bba2adf382b45305cfd42","interval":12}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
-- Дамп данных таблицы doska.jos_menu: ~31 rows (приблизительно)
...
INSERT INTO `jos_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
	('bnuiquspvb16f8q1vbk51da9q6', 1, 0, '1533825522', 'joomla|s:1140:"";', 173, 'Admin'),
	('j2dltvm4dqpivmun86vsmnpud4', 0, 1, '1533825490', 'joomla|s:860:"";', 0, ''),
...
INSERT INTO `jos_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
	(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1533821000, ''),
	(2, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 1533641922, ''),
	(3, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1533641942, '');
...
INSERT INTO `jos_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
	(173, 'Super User', 'Admin', 'zatulenko@gmail.com', '$2y$10$uZuq6HY9rXyxSVV5o93J3.9o.a5xOr0HfPHzU/03lsVzfFVlJIs42', 0, 1, '2018-06-25 11:21:27', '2018-08-09 14:15:41', '', '{}', '0000-00-00 00:00:00', 0, '', '', 0),
	(174, 'User', 'user', 'user@mail.ru', '$2y$10$BZWBG53.4h.fvFWhC0usQe6ucb1k1huBBBkB3YEBEjwNmsVier5Hi', 0, 0, '2018-08-01 06:51:52', '2018-08-07 11:07:56', '', '{"admin_style":"","admin_language":"","language":"","editor":"","helpsite":"","timezone":""}', '0000-00-00 00:00:00', 0, '', '', 0);
