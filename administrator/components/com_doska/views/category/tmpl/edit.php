...
<form action="<?php echo JRoute::_('index.php?option=com_doska&layout=edit&id=' . (int)$this->item->id); ?>"
      method="post" id="adminForm" name="adminForm" class="form-validate">

    <!--Вывод параметров в виде Табов-->
    ...
    <div class="row-fluid">
        ...
        <div class="span3">
            <!--Вывод параметров в виде Аккордиона-->
            ...
            <!--Вывод параметров в виде Слайдера-->
